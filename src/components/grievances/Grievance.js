...
91 41 143 -28 53 -29 53 -556 53 -467 0 -489 -1 -520 -20z"/>
                                                                    ...
                                                                    itemOfArr?.url?.split('.').pop().toLowerCase() === "png" ?
                                                                        ...
                                                                        itemOfArr?.url?.split('.').pop().toLowerCase() === "docx" || itemOfArr?.url?.split('.').pop().toLowerCase() === "doc" ?
                                                                            ...
                                                                            itemOfArr?.url?.split('.').pop().toLowerCase() === "xlsx" || itemOfArr?.url?.split('.').pop().toLowerCase() === "xls" ?
                                                                                ...
                                                                                :
                                                                                itemOfArr?.url?.split('.').pop().toLowerCase() === "rar" ?
                                                                                    <Svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                                                        width={28} height={28} viewBox="0 0 512.000000 512.000000"
                                                                                        preserveAspectRatio="xMidYMid meet">
   ...
   -72z"/>
                                                                                    ...
                                                                                    :
                                                                                    itemOfArr?.url?.split('.').pop().toLowerCase() === "zip" ?
                                                                                        <Svg width={26} height={32} viewBox="0 0 26 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                            <Path d="M18.1344 0H1.55036C1.08864 0 0.714355 0.374286 0.714355 1.10057V31.4286C0.714355 31.6257 1.08864 32 1.55036 32H24.4498C24.9115 32 25.2858 31.6257 25.2858 31.4286V7.416C25.2858 7.01829 25.2326 6.89029 25.1389 6.796L18.4898 0.146857C18.3955 0.0531429 18.2675 0 18.1344 0Z" fill="#ECECE5" />
                                                                                            <Path d="M18.429 0.0866699V6.85753H25.1998L18.429 0.0866699Z" fill="#DCDAD2" />
                                                                                            <Path d="M24.4498 31.9997H1.55036C1.08864 31.9997 0.714355 31.6254 0.714355 31.1637V22.2854H25.2858V31.1637C25.2858 31.6254 24.9115 31.9997 24.4498 31.9997Z" fill="#F7B800" />
                                                                                        ...
                                                                                        itemOfArr?.url?.split('.').pop().toLowerCase() === "txt" ?
                                                                                            ...
                                                                                            :
                                                                                            itemOfArr?.url?.split('.').pop().toLowerCase() === "svg" ?
                                                                                                <Svg width={26} height={32} viewBox="0 0 26 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                                    <Path d="M18.1344 0H1.55036C1.08864 0 0.714355 0.374286 0.714355 1.10057V31.4286C0.714355 31.6257 1.08864 32 1.55036 32H24.4498C24.9115 32 25.2858 31.6257 25.2858 31.4286V7.416C25.2858 7.01829 25.2326 6.89029 25.1389 6.796L18.4898 0.146857C18.3955 0.0531429 18.2675 0 18.1344 0Z" fill="#EEEFF2" />
                                                                                                    <Path d="M18.429 0.0866699V6.85753H25.1998L18.429 0.0866699Z" fill="#D7D8DD" />
                                                                                                    <Path d="M24.4498 31.9997H1.55036C1.08864 31.9997 0.714355 31.6254 0.714355 31.1637V22.2854H25.2858V31.1637C25.2858 31.6254 24.9115 31.9997 24.4498 31.9997Z" fill="#008FF7" />
...
91 41 143 -28 53 -29 53 -556 53 -467 0 -489 -1 -520 -20z"/>
                    ...
                    :
                    <Text style={{ padding: 15, textAlign: 'center', fontWeight: '700', fontSize: 16, color: '#696666' }}>There are no any grievances.</Text>
            }
