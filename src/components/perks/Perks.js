...
import { GET_CATEGORIES, GET_COLLECTION_BUSINESS_LIST } from "../../../graph/queries/perks";
...
export const Perks = ({ navigation, route }) => {
    ...
    const { loading: loading_categories, refetch: getCategories } = useQuery(GET_CATEGORIES, {
        ...
        onCompleted: (data) => {
            if (data && data.collectionFeed && data.collectionFeed.collections) {
                const temp = [];
                for (let i = data.collectionFeed.collections.length - 1; i >= 0; i--) {
                    ...
                    <View style={{ paddingHorizontal: 14, }}>
                        <View style={styles.searchInputWrapper}>
                            ...
                            <Svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <Circle cx="7.86436" cy="7.7573" r="6.65" stroke="#34519A" strokeWidth="2" />
                                <Line x1="17.2929" y1="18.5999" x2="13.9074" y2="15.2145" stroke="#34519A" strokeWidth="2" />
                            </Svg>
                        </View>
                    </View>
