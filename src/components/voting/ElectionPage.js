...
export const ElectionPage = ({ navigation, route }) => {
  ...
  const { data, loading, error, refetch } = useQuery(FETCH_BALLOTS, {
    variables: {
  ...
  const [sendEmail, { loading: sendingEmail, error: errorWithSendingEmail }] =
        ...
        <ScrollView>
          {pageNum !== elections.length + 1 ? (
            ...
            <View style={{ ...styles.wrapper, marginTop: 50 }}>
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate("Voting", { onFinishClick: true })}
                style={{
                  marginTop: 50,
                  borderWidth: 1,
                  borderColor: "#34519A",
              ...
              {emailVisible ? (
                ...
                >
                  ...
                  <TouchableOpacity
                    ...
                    <img src="${unionData.information.imageURL
                 ...
                 <h2 style="margin-top:40px;line-height: 1.3">In ${electiuonTitle}</h2>`;
                        voteInput.map((vote) => {
                          content =
                            content +
                            `<h3 style="margin-top:40px">For: ${storedBallot[vote.ballotID]
                            }</h3>\n
                      <p>You selected</p>`;
